...
(function () {
    ...
    /** Updates the 'Current Turn' display AND the board background */
    function updateTurnDisplay() {
        currentTurn = turnOrder[turnIndex];

        // 1. Update the text pill
        turnDisplay.innerText = currentTurn.toUpperCase();
        turnDisplay.style.backgroundColor = teamColors[currentTurn];

        // 2. NEW: Update the board glow/background
        // First, remove any existing turn classes
        ...
        // Then add the class for the current team
